# Graph Report - Trinity-Oaks-Homeschool  (2026-06-17)

## Corpus Check
- 4 files · ~1,042,266 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 140 nodes · 201 edges · 12 communities (9 shown, 3 thin omitted)
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a4548c8`
...
- `Notepad and Pencil Exam Icon` --semantically_similar_to--> `Chart/Graph Icon - Bar chart UI icon`  [INFERRED] [semantically similar]
  examen.png → assets/icons/grafica.png
...
Cohesion: 0.21
Nodes (22): Badge: Inicio de Ciclo (SVG), Badge: Kinder Completo (SVG), Badge: Leyenda (SVG), Badge: Mes Perfecto (SVG), Badge: Navideño (SVG), Badge: Preparatoria Completa (SVG), Badge: Primaria Completa (SVG), Badge: Primer Examen (SVG) (+14 more)
...
Cohesion: 0.17
Nodes (16): Badge: Asistente Frecuente (Frequent Assistant), Badge: Campeon (Champion), Badge: Comprometido (25 sessions), Badge: Constante (Consistent), Badge: Dedicado (10 sessions), Badge: Imparable (Rocket), Badge: Mes Perfecto (Perfect Month), Badge: Primera Actividad (First Activity) (+8 more)
...
Cohesion: 0.18
Nodes (12): Badge: Explorador Nato (Telescope), AI Assistant / Chatbot Concept, Data Visualization Concept, Education Level Tier, Educational Platform / Gamification System, Statistics / Progress Tracking, Chart/Graph Icon - Bar chart UI icon, Bar Chart / Statistics App Icon (+4 more)

### Community 8 - "Project Documentation Files"
Cohesion: 0.67
Nodes (3): CLAUDE.md – project instructions, graphify-out/GRAPH_REPORT.md, graphify-out/wiki/index.md
